...
{
	switch (channel) {
	case bitmap_channel::unspecified: return "unspecified";
	case bitmap_channel::grey: return "grey";
	case bitmap_channel::grey_alpha: return "grey_alpha";
	case bitmap_channel::rgb: return "rgb";
	case bitmap_channel::rgba: return "rgba";
	default: throw std::invalid_argument("invalid bitmap_channel value");
	}
}
...
public:
	...
	bitmap & operator= (bitmap && other) noexcept { swap(other);  return *this; }
